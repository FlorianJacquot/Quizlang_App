...
/**
 * La classe PhraseATrous représente une phrase à trous.
 *
 ...
 *
 * La classe dispose de plusieurs méthodes permettant de récupérer ou de set ses
 * différents attributs.
 */
public class PhraseATrous {

	/**
	 * Attribut qui contient la phrase correcte, sans les #.
	 */
	...
	/**
	 * Constructeur de la classe PhraseATrous. Il prend en paramètre la phrase
	 * correcte, la phrase avec les trous et la liste des mots à placer. Il
	 ...
	 * 
	 * @return la phrase avec les trous
	 */
	...
	/**
	 * Méthode qui permet de récupérer la variante correcte de l'objet Phrase. Donc
	 * la phrase sans les # et avec les mots à la bonne place.
	 * 
	 ...
	 * 
	 * @param phraseCorrecte la phrase correcte, en somme la phrase de l'input sans
	 *                       les "#"
	 */
	 ...
	 * 
	 * @param phraseAvecTrous la phrase avec les trous, en somme la phrase de
	 *                        l'input avec les "___" à la place des mots entre #
	 */
	...
	/**
	 * Méthode qui permet de set l'attribut motsAPlacer d'un objet Phrase. Ca
	 * correspond à la liste de tous les mots à placer pour une phrase donnée, dans
	 * l'ordre.
	 * 
	...
	/**
	 * Méthode qui permet de récupérer l'attribut motsAPlacer qui est la liste de
	 * tous les mots à placer de la phrase, dans l'ordre correct.
	 * 
	 * @return motsAPlacer
	 */
	...
	/**
	 * Méthode toString qui permet de représenter sous forme de chaîne de caractères
	 * l'objet PhraseATrous.
	 * 
	 * @return (String) La phrase correcte, la phrase avec les trous et la liste des
	 *         mots à placer
	 */
	@Override
	public String toString() {
		return "PhraseATrous{ " + "phraseCorrecte='" + phraseCorrecte + '\'' + ", phraseAvecTrous='" + phraseAvecTrous
