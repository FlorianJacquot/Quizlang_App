 ...
 *
 * Elle contient également deux méthodes pour lire un fichier : readFromFile() et readFile(). Ces méthodes permettent de lire les métadonnées et l'input de l'exercice contenu dans le fichier, et de créer un objet {@link Exercice} en utilisant le parseur.
 */
...
//            case EXO_A_TROU:
//                exoACreer = new Exercice(langueExo, niveauExo, pourcentageExo, (ParseurPhraseATrous) listParseurs.get(TypeExo.EXO_A_TROU), inputParser);
//                break;
//
...
//        String[] elementsFilename = path.split("\\.");
//        String[] elementFilename = elementsFilename[elementsFilename.length - 2].split("_");
//        String idExo = elementFilename[elementFilename.length - 1];
